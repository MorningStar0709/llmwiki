        ...
        <div className="w-full max-w-lg">
          ...
          {step === 'welcome' && (
            ...
            >
              ...
              <p className="mt-4 text-base text-muted-foreground leading-relaxed max-w-sm mx-auto">
                您的 LLM 会从原始来源编译并维护一个结构化的 Wiki。
              </p>

              <div className="grid grid-cols-3 gap-3 mt-10 text-left">
                {[
                  { icon: FileText, title: '来源', desc: 'PDF、笔记、转录' },
                  { icon: BookOpen, title: 'Wiki', desc: '自动生成的页面' },
                  { icon: PenTool, title: '工具', desc: '通过 MCP 搜索、读、写' },
                ].map((item) => (
            ...
            >
              ...
              >
                {creating ? (
                  ...
                  <>新建 Wiki <ArrowRight className="size-3.5" /></>
                )}
              </button>
            </motion.div>
          )}
          ...
          {step === 'connect' && (
            ...
            >
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                添加 LLM Wiki 作为连接器，以便 Claude 可以读写您的 Wiki。
              </p>
              ...
              <div className="mt-8 space-y-6">
                ...
                <div className="rounded-xl border border-border bg-card p-5">
                  ...
                  <ol className="space-y-2.5">
                    {[
                      <>打开 <strong>设置</strong></>,
                      <>进入 <strong>Connectors</strong></>,
                      <>点击 <strong>Add custom connector</strong></>,
                      '粘贴上方 URL 并授权访问',
                      '提示时使用您的账号登录',
                    ].map((text, i) => (
          ...
          {step === 'done' && (
            ...
            >
              ...
              <p className="mt-3 text-sm text-muted-foreground leading-relaxed max-w-sm mx-auto">
                上传一些来源到您的 Wiki，然后让 Claude 将它们编译成结构化页面。
              </p>
